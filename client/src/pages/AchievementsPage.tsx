...
export default function AchievementsPage() {
  const careerHighlights = [
    { label: "Competition Participations", value: 3 }, // Changed from 2 to 3
  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Training & Certifications Section - MOVED TO FIRST POSITION */}
        ...
        {/* Career Highlights Section - MOVED TO SECOND POSITION */}
